...
addon.MythicPlus.variables.portalCompendium = {
	...
	[120] = {
		...
		spells = {
			[445269] = { text = "SV", cId = { [501] = true }, mapID = 2652, locID = 2214, x = 0.4249, y = 0.0842 },
			...
			[1237215] = { text = "ED", cId = { [542] = true }, mapID = 2830, locID = 2371, x = 0.6520, y = 0.6837 },
			...
			[445441] = { text = "DFC", cId = { [504] = true }, mapID = 2651, locID = 2214, x = 0.5528, y = 0.2152 },
			[445443] = { text = "ROOK", cId = { [500] = true }, mapID = 2648, locID = 2339, x = 0.3185, y = 0.3576 },
			[448126] = { text = "ENGI", isToy = true, toyID = 221966, isEngineering = true },
			[446540] = { text = "DORN", isClassTP = "MAGE", locID = 2339, x = 0.4249, y = 0.2905 },
			[446534] = { text = "DORN", isMagePortal = true, locID = 2339, x = 0.4249, y = 0.2905 },
			[1226482] = { text = "LOU", isRaid = true, locID = 2346, x = 0.4151, y = 0.4880 },
			[1223041] = { text = "HS", isItem = true, itemID = 234389, isRaid = true, icon = 3718248, map = 2406 },
			[1239155] = { text = "MFO", isRaid = true, locID = 2371, x = 0.4153, y = 0.2141 },
			[467470] = { text = "DELVE", isToy = true, toyID = 230850 },

			[1234526] = { text = "DELVE", isToy = true, toyID = 243056, icon = 7137505, locID = 2339, x = 0.4775, y = 0.4447 },
		},
	},
	[110] = {
		...
		spells = {
			...
			[393256] = { text = "RLP", cId = { [399] = true }, mapID = 2521, locID = 2022, x = 0.6006, y = 0.7568 },
			[393262] = { text = "NO", cId = { [400] = true }, mapID = 2516, locID = 2023, x = 0.6078, y = 0.3891 },
			[393267] = { text = "BH", cId = { [405] = true }, mapID = 2520, locID = 2024, x = 0.1140, y = 0.4860 },
			[393273] = { text = "AA", cId = { [402] = true }, mapID = 2526, locID = 2025, x = 0.5827, y = 0.4239 },
			[393276] = { text = "NELT", cId = { [404] = true }, locID = 2022, x = 0.2572, y = 0.5631 },
			[393279] = { text = "AV", cId = { [401] = true }, locID = 2024, x = 0.3878, y = 0.6438 },
