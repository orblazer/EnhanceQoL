...
L["containerActionsButtonTooltip"] = "Click to use secure container items that require a hardware action."
L["containerActionsNoItems"] = "No secure container items detected."
L["containerActionsFeatureDesc"] = "When enabled, items that require a secure click are queued on the container action button. Place the anchor where you want it and click the button to use the next queued item without causing taint."
L["containerActionsManagedItems"] = "Managed Items"
L["containerActionsToggleDesc"] = "Disable individual entries below if you never want them to appear on the container action button."
