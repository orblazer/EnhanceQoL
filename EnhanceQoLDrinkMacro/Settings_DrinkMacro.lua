...
local cDrink = addon.functions.SettingsCreateCategory(nil, L["Drinks & Food"], nil, "DrinkMacro")
addon.SettingsLayout.drinkMacroCategory = cDrink

addon.functions.SettingsCreateHeadline(cDrink, L["Drink Macro"])
...
addon.functions.SettingsCreateHeadline(cDrink, L["MageFoodReminderHeadline"] or "Mage food reminder for Healer")
...
addon.functions.SettingsCreateText(cDrink, L["mageFoodReminderEditModeHint"] or "Configure details in Edit Mode.")
...
addon.functions.SettingsCreateText(cDrink, string.format(L["healthMacroPlaceOnBar"], "EnhanceQoLHealthMacro"))
if addon.variables and addon.variables.unitClass == "WARLOCK" then addon.functions.SettingsCreateText(cDrink, L["healthMacroTipReset"]) end
