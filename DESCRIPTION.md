...
*   Inventory filter (by category, upgrade track, item level, spec relevance).
...
*   Option to show party frames solo.
*   Option to hide player frame.
...
*   Combat rez tracker, potion tracker, BR tracker.
